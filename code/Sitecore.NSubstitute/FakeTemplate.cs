...
namespace Sitecore.NSubstituteUtils
{
    public class FakeTemplate
    {
        ...
        [Obsolete("Use WithStandardValues method instead.")]
        public FakeTemplate WithStandatdValues(ID standardValuesHolderId)
        {
            return WithStandardValues(standardValuesHolderId);
        }

        public FakeTemplate WithStandardValues(ID standardValuesHolderId)
        {
